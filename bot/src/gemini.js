...
async function analyzeDream(dreamText) {
  try {
    const response = await axios.post(
      'https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${process.env.GEMINI_API_KEY}', // Замените на реальный URL Gemini API
      { text: dreamText },
